...
const inserirFilmeGenero = async function(filmeGenero, contentType){
    ...
    //Novos itens adicionados no dia 06.05
        ...
        if(String(contentType).toLowerCase() == 'application/json')
            {
                if (id                                == ''           || id                       == undefined    || id                    == null || isNaN(id)  || id  <= 0   ||
                    filmeGenero.id_filme              == ''           || filmeGenero.id_filme     == undefined    || filmeGenero.id_filme  == null || isNaN(filmeGenero.id_filme)  || filmeGenero.id_filme <=0 ||
/*Add 06.05*/       filmeGenero.id_genero             == ''           || filmeGenero.id_genero    == undefined    || filmeGenero.id_genero == null || isNaN(filmeGenero.id_genero) || filmeGenero.id_genero<=0
                )
                {
                    return message.ERROR_REQUIRED_FIELDS //400
                }else{
...
const buscarFilmeGenero = async function(id){
    ...
    //Função adicionada na aula 06/05
...
module.exports = {
    ...
    //Funções adicionadas na aula 06/05
        //Material desta aula no Notion (Back-end 3º Semestre)
